...
CREATE INDEX IF NOT EXISTS idx_oidc_providers_enabled ON oidc_providers(enabled, public_listed, id);
...
CREATE INDEX IF NOT EXISTS idx_user_identities_user ON user_identities(user_id, id);
...
CREATE INDEX IF NOT EXISTS idx_user_recovery_codes_user ON user_recovery_codes(user_id, id);
...
CREATE INDEX IF NOT EXISTS idx_user_devices_user ON user_devices(user_id, revoked_at, expires_at);
...
CREATE INDEX IF NOT EXISTS idx_auth_challenges_kind_user ON auth_challenges(kind, user_id, id);
...
CREATE INDEX IF NOT EXISTS idx_auth_login_attempts_blocked ON auth_login_attempts(blocked_until);
