...
const VpnPeers = () => import('./views/VpnPeers.vue')
...
{path:'/tunnels', component:Tunnels, meta:{auth:true}}, {path:'/tokens', component:Tokens, meta:{auth:true}}, {path:'/clients', component:Clients, meta:{auth:true}}, {path:'/remote-servers', component:RemoteServers, meta:{auth:true}}, {path:'/credentials', component:Credentials, meta:{auth:true}}, {path:'/vpn', component:VpnPeers, meta:{auth:true}}, {path:'/webssh/:sessionId', name:'webssh-terminal', component:WebSSHTerminal, meta:{auth:true}}, {path:'/webssh/:sessionId/sftp', name:'web-sftp', component:WebSFTP, meta:{auth:true}}, {path:'/servers', component:Servers, meta:{auth:true, admin:true}}, {path:'/downloads', component:Downloads, meta:{auth:true, admin:true}}, {path:'/users', component:Users, meta:{auth:true, admin:true}}, {path:'/sso-providers', component:SSOProviders, meta:{auth:true, admin:true}}, {path:'/account/security', component:AccountSecurity, meta:{auth:true}}, {path:'/audit-logs', component:AuditLogs, meta:{auth:true, admin:true}}
]})
