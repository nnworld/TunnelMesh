...
const menuItems = () => [
  ['/', 'navigation.dashboard'], ['/agents', 'navigation.agents'], ['/clients', 'navigation.clients'], ['/routes', 'navigation.routes'], ['/tunnels', 'navigation.tunnels'], ['/tokens', 'navigation.tokens'], ['/remote-servers', 'navigation.remoteServers'], ['/credentials', 'navigation.credentials'],
